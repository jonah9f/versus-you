...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'GoalsPage')
              : GoalsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ReminderSchedulePageWidget.routeName,
          path: ReminderSchedulePageWidget.routePath,
          builder: (context, params) => ReminderSchedulePageWidget(),
        ),
        FFRoute(
          name: ScreenTimeGoalPageWidget.routeName,
          path: ScreenTimeGoalPageWidget.routePath,
          builder: (context, params) => ScreenTimeGoalPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: VersusYouProPageWidget.routeName,
          path: VersusYouProPageWidget.routePath,
          builder: (context, params) => VersusYouProPageWidget(),
        ),
        FFRoute(
          name: HelpOutlineWidget.routeName,
          path: HelpOutlineWidget.routePath,
          builder: (context, params) => HelpOutlineWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TermsPrivacyPageWidget.routeName,
          path: TermsPrivacyPageWidget.routePath,
          builder: (context, params) => TermsPrivacyPageWidget(),
        ),
        FFRoute(
