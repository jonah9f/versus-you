            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Choose the area that would make the biggest difference in your life right now.',
                    textAlign: TextAlign.center,
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.manrope(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                _model.selectedPrimaryGoal = 'discipline';
                                safeSetState(() {});
                              },
                              text: '🎯 Discipline',
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                _model.selectedPrimaryGoal = 'career';
                                safeSetState(() {});
                              },
                              ...
                              options: FFButtonOptions(
                                ...
                                iconPadding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 0.0),
                                color: _model.selectedPrimaryGoal == 'career'
                                    ? Color(0xFF78E84C)
                                    : Color(0xFFB0B0B0),
                                textStyle: FlutterFlowTheme.of(context)
                                    .titleSmall
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                _model.selectedPrimaryGoal = 'sleep';
                                safeSetState(() {});
                              },
                              text: '🌙 Sleep',
                              options: FFButtonOptions(
                                ...
                                iconPadding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 0.0),
                                color: _model.selectedPrimaryGoal == 'sleep'
                                    ? Color(0xFF78E84C)
                                    : Color(0xFFB0B0B0),
                                textStyle: FlutterFlowTheme.of(context)
                                    .titleSmall
                        ...
                        Column(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                _model.selectedPrimaryGoal = 'fitness';
                                safeSetState(() {});
                              },
                              text: '💪 Fitness',
                              options: FFButtonOptions(
                                ...
                                iconPadding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 0.0),
                                color: _model.selectedPrimaryGoal == 'fitness'
                                    ? Color(0xFF78E84C)
                                    : Color(0xFFB0B0B0),
                                textStyle: FlutterFlowTheme.of(context)
                                    .titleSmall
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                _model.selectedPrimaryGoal = 'confidence';
                                safeSetState(() {});
                              },
                              text: '⚡ Confidence',
                              options: FFButtonOptions(
                            ...
                            FFButtonWidget(
                              ...
                              options: FFButtonOptions(
                                ...
                                iconPadding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 0.0),
                                color: _model.selectedPrimaryGoal ==
                                        'mental performance'
                                    ? Color(0xFF78E84C)
                                    : Color(0xFFB0B0B0),
                                textStyle: FlutterFlowTheme.of(context)
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model.selectedPrimaryGoal != null &&
                          _model.selectedPrimaryGoal != '') {
                        if (Navigator.of(context).canPop()) {
                          context.pop();
                        }
                        context.pushNamed(
                          Onboarding5Widget.routeName,
                          queryParameters: {
