                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        valueOrDefault<String>(
                                          '+ ${valueOrDefault(currentUserDocument?.weeklyScoreChange, 0).toString()} This Week',
                                          '0',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                ...
                                children: [
                                  ...
                                  AuthUserStreamWidget(
                                    builder: (context) => Text(
                                      '${valueOrDefault<String>(
                                        valueOrDefault(
                                                currentUserDocument?.bestStreak,
                                                0)
                                            .toString(),
                                        '0',
                                      )} Days',
                                ...
                                children: [
                                  ...
                                  AuthUserStreamWidget(
                                    builder: (context) =>
                                      ...
                                      percent: (int xp, int xpGoal) {
                                        return xpGoal <= 0
                                            ? 0.0
                                            : (xp / xpGoal).clamp(0.0, 1.0);
                                      }(
                                          valueOrDefault(
                                              currentUserDocument?.xp, 0),
                                          valueOrDefault<int>(
                            ...
                            children: [
                              ...
                              if ((int completed) {
                                return completed >= 100;
                                  ...
                                  currentUserDocument?.challengesCompleted, 0)))
                                AuthUserStreamWidget(
                                  builder: (context) => Container(
                                    width: 100.0,
                                    height: 100.0,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: AuthUserStreamWidget(
                                        builder: (context) => Text(
                                          'Reached Level ${valueOrDefault<String>(
                                            valueOrDefault(
                                                    currentUserDocument?.level,
                                                    0)
                                                .toString(),
                                    ...
                                    children: [
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => Text(
                                          valueOrDefault<String>(
                                            (int minutes) {
                                              return "Recommended limit: ${minutes ~/ 60}h ${minutes % 60}m";
                                            }(valueOrDefault(
                                                currentUserDocument
                                                    ?.screenTimeGoalMinutes,
                                                0)),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                            ...
                                            builder: (context) => Text(
                                              valueOrDefault<String>(
                                                (int usedMinutes,
                                                  ...
                                                  return usedMinutes <=
                                                          goalMinutes
                                                      ? "${goalMinutes - usedMinutes} min under your daily limit"
                                                      : "${usedMinutes - goalMinutes} min over your daily limit";
                                                }(
                                                    valueOrDefault(
                                                        currentUserDocument
                                                            ?.todaySocialMediaMinutes,
                                        ...
                                        if ((int usedMinutes, int goalMinutes) {
                                          return usedMinutes <= goalMinutes;
                                        }(
                                            valueOrDefault(
                                                currentUserDocument
                                                    ?.todaySocialMediaMinutes,
                                  ...
                                  AuthUserStreamWidget(
                                    builder: (context) =>
                                        LinearPercentIndicator(
                                      percent:
                                          (int usedMinutes, int goalMinutes) {
                                        return goalMinutes <= 0
                                            ? 0.0
                                            : (usedMinutes / goalMinutes)
                                                .clamp(0.0, 1.0);
                                      }(
                                              valueOrDefault(
                                                  currentUserDocument
                                      ...
                                      valueOrDefault<String>(
                                        (int usedMinutes, int goalMinutes) {
                                          return usedMinutes <= goalMinutes
                                              ...
                                              : "You're over your limit. Reset and finish the day strong.";
                                        }(
                                            valueOrDefault(
                                                currentUserDocument
                                                    ?.todaySocialMediaMinutes,
