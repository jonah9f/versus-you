...
Future resetMissedDayReminders() async {
  ...
  // Cancel the existing 7-day inactivity chain.
  for (int day = 1; day <= 7; day++) {
    await notificationsPlugin.cancel(920000 + day);
  }
  ...
  // Start a fresh 7-day inactivity chain from now.
  for (int day = 1; day <= 7; day++) {
  ...
  print('Missed-day reminders reset and rescheduled.');
}
