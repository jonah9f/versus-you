...
class Onboarding7Widget extends StatefulWidget {
  ...
  static String routeName = 'Onboarding7';
  static String routePath = '/onboarding7';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Describe what you want your life to look like six months from now. Be specific.',
                    textAlign: TextAlign.center,
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.manrope(
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'In 6 months I see myself...',
                    ...
                    onPressed: () async {
                      if (_model.textController.text != '') {
                        await currentUserReference!
                          ...
                          sixMonthVision: _model.textController.text,
                          sixMonthTargetDate:
                              functions.addMonthsToDate(getCurrentTimestamp, 6),
                        ));
                        triggerPushNotification(
                          notificationTitle: '6-Month Review Ready',
                          notificationText:
                              'It’s time to review your 6-month vision. See how far you’ve come and set your next target.',
                          scheduledTime:
                              currentUserDocument!.sixMonthTargetDate!,
                          notificationSound: 'default',
                          userRefs: [currentUserReference!],
                          initialPageName: 'MyFuturePage',
                          parameterData: {},
                        );

                        context.pushNamed(
                          Onboarding8Widget.routeName,
                          queryParameters: {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Write your 6 - month vision to continue',
